...
<div class="panel-wrap list_data">

	<ul class="list_data_tabs memberhero-tabs">
		...
		<?php endforeach; ?>
		<?php do_action( 'memberhero_list_write_data_tabs' ); ?>
	</ul>

	<?php
		self::output_tabs();
		do_action( 'memberhero_list_data_panels' );
	?>
	<div class="clear"></div>
</div>