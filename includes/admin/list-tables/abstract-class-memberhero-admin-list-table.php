...
/**
 * MemberHero_Admin_List_Table class.
 */
abstract class MemberHero_Admin_List_Table {
	...
	public function __construct() {
		if ( $this->list_table_type ) {
			...
			add_filter( 'views_edit-' . $this->list_table_type, array( $this, 'get_views' ), 10 );
		}
	}
	...
	public function maybe_render_blank_state( $which ) {
		...
		if ( $post_type === $this->list_table_type && 'bottom' === $which ) {
			if ( ! in_array( $post_type, apply_filters( 'memberhero_render_blank_state_turnedoff', array() ) ) ) {
