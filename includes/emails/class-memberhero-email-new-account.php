...
/**
 * MemberHero_Email_New_Account class.
 */
class MemberHero_Email_New_Account extends MemberHero_Email {
	...
	public function __construct() {
		$this->id             = 'new_account';
		$this->title          = __( 'New account notification', 'memberhero' );
		$this->description    = __( 'New account notification emails are sent to chosen recipient(s) when a new user is registered.', 'memberhero' );
	...
	public function get_default_subject() {
		return __( 'You have got a new member! @{user_login}', 'memberhero' );
	}
	...
	public function get_default_heading() {
		return __( '@{user_login} just registered!', 'memberhero' );
	}
...
return new MemberHero_Email_New_Account();